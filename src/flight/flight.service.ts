...
export class FlightService {
  private flights = [
    {
      ...
      from: 'CMB',
      to: 'BKK',
      departTime: '2025-12-11T09:00',
      arriveTime: '2025-12-11T13:00',
      price: 450,
    },
    {
      id: 2,
      from: 'CMB',
      to: 'BKK',
      departTime: '2025-12-10T15:00',
      arriveTime: '2025-12-10T21:00',
      price: 400,
    },
    {
      id: 3,
      from: 'CMB',
      to: 'SIN',
      departTime: '2025-12-12T12:00',
      arriveTime: '2025-12-12T16:00',
      price: 350,
    },
  ];
  ...
  async cheapestFlight(from: string, to: string, date: string) {
    const delay = 800;
    await new Promise((res) => setTimeout(res, delay));
